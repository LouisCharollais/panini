 ...
 */
final class Version20231115133056 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE equipe (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, createur_id INTEGER DEFAULT NULL, nom VARCHAR(255) NOT NULL, CONSTRAINT FK_2449BA1573A201E5 FOREIGN KEY (createur_id) REFERENCES membre (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
