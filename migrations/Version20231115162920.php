 ...
 */
final class Version20231115162920 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE equipe (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, createur_id INTEGER DEFAULT NULL, nom VARCHAR(255) NOT NULL, published BOOLEAN NOT NULL, CONSTRAINT FK_2449BA1573A201E5 FOREIGN KEY (createur_id) REFERENCES membre (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE panini (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, album_id INTEGER NOT NULL, membre_id INTEGER DEFAULT NULL, nom VARCHAR(255) NOT NULL, image_name VARCHAR(255) NOT NULL, CONSTRAINT FK_4D5D1DD51137ABCF FOREIGN KEY (album_id) REFERENCES album (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_4D5D1DD56A99F74A FOREIGN KEY (membre_id) REFERENCES membre (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('CREATE INDEX IDX_4D5D1DD51137ABCF ON panini (album_id)');
        $this->addSql('CREATE INDEX IDX_4D5D1DD56A99F74A ON panini (membre_id)');
